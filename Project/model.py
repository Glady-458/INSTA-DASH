...
data_common = pd.read_csv(r"kind.csv")
...
data2.rename(columns = {'Time of Post':'date','Username':'username','No. of Post':'numberPosts','following':'numberFollowing','followers':'numberFollowers','Likes':'numberLikes','is Video':'isVideo','Tags':'tags'}, inplace = True)
